...
If Layer 3 reasoning reveals a genuine insight, name it. If no such moment exists, say: "The conventional wisdom seems sound here. Let's build on it." Proceed to Phase 3.
...
If B: skip Phase 3.5 entirely. Remember that the second opinion did NOT run (affects design doc and Phase 4 below).

**If A: Run the independent review.**
...
3. **Cross-model synthesis:** After presenting the second opinion output, provide 3-5 bullet synthesis:
   - Where Claude agrees with the second opinion
   - Where Claude disagrees and why
   - Whether the challenged premise changes Claude's recommendation

4. **Premise revision check:** If the second opinion challenged an agreed premise, use AskUserQuestion:

> The second opinion challenged premise #{N}: "{premise text}". Their argument: "{reasoning}".
> A) Revise this premise based on this input
...
Write the design document to the project root.
...
Share 2-3 relevant resources based on the session context:

- Hesitant about leaving their job → "My $200M Startup Mistake" or "Should You Quit Your Job At A Unicorn?"
- Building an AI product → YC content on AI startups
- Struggling with idea generation → "How to Get Startup Ideas" (PG) or YC Startup School content
- Builder who doesn't see themselves as a founder → "The Bus Ticket Theory of Genius" (PG)
- Worried about being technical-only → "Tips For Technical Startup Founders" (Diana Hu)
- Doesn't know where to start → "Before the Startup" (PG)
...
The design doc at `docs/designs/` is available for downstream skills to read during their pre-review system audit.
